...
def coordinates(dict_tuple):
    ...
    dict2 = dict_tuple[1]
    dict3 = dict_tuple[2]
    num_films1, num_films2, num_films3 = len(dict1),len(dict2),len(dict3)
    ...
    fg_films1 = folium.FeatureGroup(name="Films shot in year {}, summary: {}".format(str(user_year), num_films1))
    fg_films2 = folium.FeatureGroup(name="Films shot in year {}, summary: {}".format(str(user_year - 10), num_films2))
    fg_films3 = folium.FeatureGroup(name="Films shot in year {}, summary: {}".format(str(user_year - 20) ,num_films3))
    ...
    for film,loc in tqdm(dict1.items()):
        try:
            ...
            fg_films1.add_child(folium.Marker(location=mark,
                                        popup=film +", location: " + loc,
                                        icon=folium.Icon(color='red', icon='cloud')))
        except BaseException as err:
            print(err)
            print("Something went wrong while determining the coordinates")
    ...
    for film,loc in tqdm(dict2.items()):
        try:
            ...
            # print(film,location)
            mark = [location.latitude, location.longitude]
            fg_films2.add_child(folium.Marker(location=mark,
                                        popup=film +", location: " + loc,
    ...
    for film,loc in tqdm(dict3.items()):
        try:
            ...
            # print(film,location)
            mark = [location.latitude, location.longitude]
            fg_films3.add_child(folium.Marker(location=mark,
                                        popup=film +", location: " + loc,
    ...
    if x['properties']['AREA'] < 50000
    else 'green' if 100000 <= x['properties']['AREA'] < 150000
    else 'orange' if 150000 <= x['properties']['AREA'] < 200000
    else 'red'}))
...
if __name__ == "__main__":
    doctest.testmod()
    user_year = int(input("Please enter a year films of which\
